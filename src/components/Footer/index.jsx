...
const Footer = () => {
  return (
    <footer className="footer" style={{ display: "flex", Bottom: "0" }}>
      <div id="wrapper">
        <div id="footer">
          <div className="footerFloat">
            <p>Procrest 123 Street, sevilla, 1000</p>
            <div>
              <svg
      ...
      <div className="copyright">
        <p>
          &copy; Copyright Procrest&nbsp;&nbsp;&nbsp;&nbsp; Términos y
